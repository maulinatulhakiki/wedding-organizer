                ...
                <table class="min-w-full table-auto">
                    <thead class="justify-between">
                        <tr class="bg-gray-600 w-full">
                            ...
                            <th class="px-16 py-2 text-left">
                                <span class="text-white">ALAMAT PELANGGAN</span>
                            </th>
                            <th class="px-16 py-2 text-left">
                                <span class="text-white">NOMOR HP PELANGGAN</span>
                            </th>
                            <th class="px-16 py-2 text-left">
                                <span class="text-white">EMAIL PELANGGAN</span>
                            </th>
                            <th class="px-16 py-2">
                    ...
                    <tbody class="bg-gray-200">
                        ...
                        <tr class="border bg-white">
                            ...
                            <td class="px-10 py-2 text-center">
                                <a href="{{ route('admin.pelanggan.edit', $pelanggan) }}" class="bg-indigo-600 px-4 py-2 rounded shadow-sm text-xs text-white focus:outline-none">EDIT</a>
                                <a href="{{ route('admin.pelanggan.show', $pelanggan) }}" class="bg-gray-600 px-4 py-2 rounded shadow-sm text-xs text-white focus:outline-none">SHOW</a>
                                <button onClick="destroy(this.id)" id="{{ $pelanggan }}" class="bg-red-600 px-4 py-2 rounded shadow-sm text-xs text-white focus:outline-none">HAPUS</button>
                            </td>
                        </tr>
                        @empty
