...
<main class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-300">
    <div class="container mx-auto px-6 py-8">
        <div class="p-6 bg-white rounded-md shadow-md">
            ...
            <hr class="mt-4">
            <a href="{{ route('admin.pelanggan.edit', ['pelanggan' => $pelanggan->id]) }}">Edit</a>
            ...
            <div class="grid grid-cols-1 gap-6 mt-4">
                ...
                <div>
                    <label class="text-gray-700" for="alamat_pelanggan">ALAMAT PELANGGAN</label>
                    <input class="form-input w-full mt-2 rounded-md bg-gray-200 focus:bg-white" type="text"
                        name="alamat" value="{{ old('alamat_pelanggan') }}" placeholder="Alamat Rumah">
                ...
                <div>
                    <label class="text-gray-700" for="telepon_pelanggan">NO HP PELANGGAN</label>
                    <input class="form-input w-full mt-2 rounded-md bg-gray-200 focus:bg-white" type="text"
                        name="telepon_pelanggan" value="{{ old('telepon_pelanggan') }}" placeholder="No HP Aktif">
                ...
                <div>
                    <label class="text-gray-700" for="email_pelanggan">EMAIL</label>
                    <input class="form-input w-full mt-2 rounded-md bg-gray-200 focus:bg-white" type="text"
                        name="email_pelanggan" value="{{ old('email_pelanggan') }}" placeholder="Email Aktif">
