            ...
            <div class="inline-block min-w-full shadow-sm rounded-lg overflow-hidden">
                <table class="min-w-full table-auto">
                    ...
                    <tbody class="bg-gray-200">
                        @forelse($pembayaran1 as $pembayaran)
                        <tr class="border bg-white">
                            ...
                            <td class="px-10 py-2 text-center">
                                ...
                                <a href="{{ route('admin.pembayaran.show', $pembayaran) }}"
                                    class="bg-gray-600 px-4 py-2 rounded shadow-sm text-xs text-white focus:outline-none">SHOW</a>
                                <button onClick="destroy(this.id)" id="{{$pembayaran}}"
                ...
                @if ($pembayaran1->hasPages())
                <div class="bg-white p-3">
                    {{ $pembayaran1->links('vendor.pagination.tailwind') }}
                </div>
                @endif
            </div>
        </div>
